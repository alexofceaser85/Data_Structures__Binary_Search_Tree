package tests.viewmodel.savebinarytree;
...
class TestSaveFile {
	...
	private final String filePathForRootNodeSaveTests = FilePaths.TEST_FILE_FOR_VIEW_MODEL_SAVE_FILE_UNIT_TESTS + "\\shouldSaveFileWithRootNode";
	private final String filePathForQuestionRootNodeAndChildrenSaveTests = FilePaths.TEST_FILE_FOR_VIEW_MODEL_SAVE_FILE_UNIT_TESTS + "\\shouldSaveFileWithQuestionRootNodeAndChildren";
	private final String filePathForEmptyQuestionRootNode = FilePaths.TEST_FILE_FOR_VIEW_MODEL_SAVE_FILE_UNIT_TESTS + "\\shouldSaveEmptyQuestionNode";
	...
	public void shouldNotSaveFileWithNullFile() {
		...
		SaveBinaryTreeViewModel saveBinaryTree = new SaveBinaryTreeViewModel();
